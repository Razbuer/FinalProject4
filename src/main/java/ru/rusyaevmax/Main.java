...
import ru.rusyaevmax.domain.City;
import ru.rusyaevmax.domain.Country;
import ru.rusyaevmax.domain.CountryLanguage;
import ru.rusyaevmax.redis.CityCountry;
import ru.rusyaevmax.redis.Language;
...
public class Main {
    ...
    private SessionFactory prepareRelationalDb() {
        ...
        properties.put(Environment.URL, "jdbc:p6spy:mysql://localhost:3387/world");
